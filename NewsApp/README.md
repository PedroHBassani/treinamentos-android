# NewsApp
Aplicativo Android desenvolvido com Jetpack Compose e as bibliotecas oficiais mais recentes (Arquitetura, Coroutines, Retrofit, Hilt).  
Baseado no repositório [NewsApp](https://github.com/lofcoding/NewsApp).
